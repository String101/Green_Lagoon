    ...
    public class BookingController : Controller
    {
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
            ...
            var bookedVillas = _unitOfWork.Booking.GetAll(u => u.Status == SD.StatusApproved || u.Status == SD.StatusCheckedIn).ToList();
                ...
                int roomsAvailable = SD.VillaRoomAvailable_Count(villa.Id, villaNumbersList, booking.CheckInDate, booking.Nights, bookedVillas);

            if (roomsAvailable == 0)
            {
                TempData["error"] = "Rooms fully booked";
                return RedirectToAction(nameof(FinalizeBooking), new
                {
                    villaId = booking.VillaId,
                    checkinInDate = booking.CheckInDate,
        ...
        public IActionResult CheckIn(Booking booking)
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Booking updated Successfull";
        ...
        public IActionResult CheckOut(Booking booking)
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Booking coompleted Successfull";
            return RedirectToAction(nameof(BookingDetails), new { bookingId = booking.Id });
        }
        [HttpPost]
        [Authorize(Roles = SD.Role_Admin)]
        ...
        public IActionResult CancelBooking(Booking booking)
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Booking Cancelled Successfull";
            return RedirectToAction(nameof(BookingDetails), new { bookingId = booking.Id });
        }
